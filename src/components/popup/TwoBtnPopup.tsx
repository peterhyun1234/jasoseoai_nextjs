...
interface Props {
    ...
    onClickEventSecond?: any,
    btnTextFirst?: any,
    btnTextSecond?: any,
    content?: any,
}

const TwoBtnPopup = ({ open, onClickEventFirst, onClickEventSecond, btnTextFirst, btnTextSecond, content }: Props) => {
            ...
            >
                <DialogBoxDiv>
                    ...
                    <DialogBtnDiv>
                        ...
                        <VerticalDivider/>
                        <DialogBtn 
                            onClick={onClickEventSecond !== undefined ? onClickEventSecond : undefined}
                            textColor={"#327bff"}>{btnTextSecond}</DialogBtn>
                    </DialogBtnDiv>
                </DialogBoxDiv>
            </CustomDialog>
        </div>
